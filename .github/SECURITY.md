...
**Hide Digital Security** mengutamakan keamanan data pengguna, enkripsi sesi multi-tenant, dan integritas gerbang API WhatsApp. Jika Anda menemukan kerentanan keamanan (_vulnerability_), mohon laporkan melalui:

1. **GitHub Private Vulnerability Reporting**: [Report a vulnerability](../../security/advisories/new)
2. **Email Tim Keamanan**: [`admin@hidessh.com`](mailto:admin@hidessh.com)
