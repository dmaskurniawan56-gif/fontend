...
ARG NEXT_PUBLIC_APP_NAME="Wahide"
ARG NEXT_PUBLIC_APP_URL="https://wa.hidessh.com"
ARG NEXT_PUBLIC_API_BASE_URL="https://api-wa.hidessh.com/api/v1"
...
ARG NEXT_PUBLIC_TURNSTILE_SITE_KEY="0x4AAAAAADOgaNLRGt1f6A6-"
