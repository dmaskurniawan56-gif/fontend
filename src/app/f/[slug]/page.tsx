    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-3xl border border-border/70 bg-card p-6 sm:p-8 text-center shadow-xl">
        ...
        <p className="text-xs text-foreground-muted leading-relaxed sm:text-sm mb-6">
          Untuk menjaga keamanan ekosistem, kepatuhan regulasi, dan mencegah
          penyalahgunaan platform, akses pengisian formulir melalui tautan web
          publik telah dinonaktifkan secara permanen. Seluruh formulir Wahide
          bersifat privat internal.
        </p>
        ...
        <div className="rounded-2xl bg-muted/40 p-4 text-left text-xs text-foreground-muted border border-border/50 mb-6 space-y-2">
          ...
          <p className="text-[11px] leading-relaxed">
            Data hanya dapat diinput dan dikelola secara privat oleh pengguna
            terdaftar melalui dashboard resmi Wahide.
          </p>
        </div>
