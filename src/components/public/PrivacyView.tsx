      ...
      <div className="space-y-8 text-xs sm:text-sm font-semibold text-foreground-secondary leading-relaxed">
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>
            ...
            serta prinsip tata kelola data global{" "}
            <em>General Data Protection Regulation (GDPR)</em>. Hide Group
            bertindak sebagai Pengendali Data dan Prosesor Data yang bertanggung
            jawab atas pengelolaan informasi yang Anda percayakan.
          </p>
        </section>
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>
            Dalam menyediakan layanan gateway WhatsApp Wahide, kami mengumpulkan
            kategori data berikut:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-xs sm:text-sm">
            <li>
              <strong>Data Akun:</strong> Nama lengkap, alamat email bisnis,
              nomor telepon terverifikasi, dan kata sandi terenkripsi (bcrypt).
            </li>
            <li>
              <strong>Data Sesi WhatsApp:</strong> Kunci sesi enkripsi (Noise
              Protocol / Signal Protocol keys) yang dihasilkan saat proses scan
              QR Code pairing.
            </li>
            <li>
              <strong>Data Transaksi:</strong> Riwayat invoice tagihan, kuota
              pesan yang digunakan, dan bukti transfer pembayaran top-up.
            </li>
            <li>
              <strong>Data Log Teknis:</strong> Alamat IP, user-agent browser,
              timestamp login, dan log audit keamanan sistem.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>Hide Group memegang prinsip privasi tingkat tinggi:</p>
          <div className="p-4 rounded-md bg-wise-green/10 dark:bg-wise-green/5 border border-wise-green/20 space-y-2">
            ...
            <p className="text-xs text-foreground-secondary">
              Kami <strong>TIDAK PERNAH</strong> membaca, menyimpan, atau
              menjual isi konten pesan percakapan WhatsApp pribadi Anda kepada
              pihak mana pun. Pesan dikirim secara transparan melalui protokol
              enkripsi WhatsApp langsung ke penerima.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>
            Seluruh infrastruktur basis data dipartisi secara ketat berdasarkan{" "}
            <code>tenant_id</code>. Seluruh token sesi disimpan menggunakan
            standar enkripsi simetris <strong>AES-GCM 256-bit</strong>. Akses
            antar tenant dibatasi secara ketat di tingkat arsitektur backend
            terisolasi sehingga tidak ada kebocoran data antar pengguna.
          </p>
        </section>
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>
            Sebagai pemilik data pribadi, Anda memiliki hak-hak yang dijamin
            oleh undang-undang:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-xs sm:text-sm">
            <li>
              <strong>Hak Akses &amp; Portabilitas:</strong> Hak untuk melihat
              dan mengunduh seluruh data kontak dan riwayat pengiriman Anda.
            </li>
            <li>
              <strong>Hak Koreksi:</strong> Hak untuk memperbarui data profil
              akun kapan saja melalui dasbor pengaturan.
            </li>
            <li>
              <strong>
                Hak Penghapusan Permanen (*Right to be Forgotten*):
              </strong>{" "}
              Hak untuk meminta penghapusan permanen seluruh akun, database
              kontak, dan sesi WhatsApp dari server kami.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3 p-6 rounded-md border border-border bg-surface">
          ...
          <p>
            Kami menggunakan Cookie terbatas untuk mengingat preferensi bahasa (
            <code>NEXT_LOCALE</code>) dan mengintegrasikan Cloudflare Turnstile
            untuk proteksi keamanan dari serangan bot tanpa melacak riwayat
            penjelajahan pribadi Anda.
          </p>
          <p>
            Wahide beroperasi sebagai platform otomasi independen dan bukan
            merupakan bagian dari Meta Platforms, Inc. atau WhatsApp LLC.
            Seluruh pengelolaan transmisi data dilakukan secara mandiri sesuai
            protokol standar perpesanan tanpa membagikan data pribadi Anda
        ...
        <section className="space-y-4 p-6 rounded-md border border-border bg-surface">
          ...
          <div className="p-4 rounded-md bg-muted/30 border border-border text-xs space-y-1">
            <div>
              <strong>Tim Kepatuhan Data (DPO Desk):</strong> Hide Group
            </div>
            <div>
              <strong>Email:</strong>{" "}
              <a
            ...
            <div>
              <strong>WhatsApp Hotline:</strong> 0877111301818
            </div>
            <div>
              <strong>Alamat:</strong> Jl. Kampung Baris No.391, Karangturi,
              Kec. Semarang Tim., Kota Semarang, Jawa Tengah 50124
            </div>
          </div>
        </section>
      </div>
