...
import { MessageListTable } from "../components/messages/MessageListTable";
import { ComposeMessageCard } from "../components/messages/ComposeMessageCard";
import { WhatsAppChatPreview } from "../components/messages/WhatsAppChatPreview";
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-3 sm:space-y-8 sm:p-6 lg:p-8">
      <Tabs
        ...
        className="space-y-6"
      >
        {/* 1. Header Section matching DevicesView & CampaignsView */}
        ...
        >
          ...
          >
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
              ...
              {/* Right Column: Real-time Live WhatsApp Chat Preview */}
